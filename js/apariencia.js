...
{ 
	...
	{
		case 0:
      document.body.classList.remove('theme-divertido','theme-gotico', 'theme-rustico');
      document.body.classList.add('theme-original');
			document.getElementById("cgimg").src = "img/opor.svg";
			changeTheme();
		break;
		case 1:
			document.body.classList.remove('theme-original','theme-gotico', 'theme-rustico');
      document.body.classList.add('theme-divertido');
			document.getElementById("cgimg").src = "img/opart.jpg";
			changeTheme();
		break;
		case 2:
			document.body.classList.remove('theme-original','theme-divertido', 'theme-rustico');
      document.body.classList.add('theme-gotico');	
			document.getElementById("cgimg").src = "img/opgot.png";
			changeTheme();
		break;
		case 3:
			document.body.classList.remove('theme-original','theme-divertido', 'theme-gotico');
...
{
  document.getElementById('nombre').innerHTML='Bienvenido/a ' + objUser.nombreUsuario;
}
...
function actualizarLimiteEnPantalla() 
{
  ...
  document.getElementById('lim-dis').innerHTML ='Tu límite actual es de: $'+ extraccionRestante; 
}
function actualizarDeudaEnPantalla()
{
	document.getElementById('deuda').innerHTML ='Tu prestamo actual es de: $ '+ deuda.toFixed(2); 
	document.getElementById('tasa').innerHTML ='Tu tasa de interes actual es de: %'+ porcentaje; 
